...
import org.example.carrental.repository.*;
...
public class E2E {
    ...
    void RentalTest() throws Exception {
        //사용자 등록
        UserRequestDTO userRequest = UserRequestDTO.builder().name("user1").build();
        ...
        userId = objectMapper.readValue(userResponse, UserResponseDTO.class).getId();
        //자동차 등록
    ...
    void notAllowRentalForRentedCar() throws Exception {
        ...
        // 사용자 2명 등록
        UserRequestDTO user2Request = UserRequestDTO.builder().name("user2").build();
        ...
        Long user2Id = objectMapper.readValue(user2Response, UserResponseDTO.class).getId();
    ...
    void invalidDataValidation() throws Exception {
        ...
        // 사용자 잘못된 데이터 등록
        UserRequestDTO invalidUserRequest = UserRequestDTO.builder().name("").build();
